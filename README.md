...
⋅⋅2.Передать строку JSON на сервер
⋅⋅3.Должно быть не менее 5 свойств у объекта (Например: Список студентов 1 - Имя, 2 - Фамилия, 3- группа, 4 - возраст, 5- изучаемый предмет)
⋅⋅4.Записать полученную строку в файл на сервере
⋅⋅5.Вернуть строки JSON с сервера
⋅⋅6.Создать из строки JSON объект
⋅⋅7.Получить список всех объектов хранящихся на сервере в файле (можно в виде таблицы, в виде карточек, в виде контейнеров и т.д.)
